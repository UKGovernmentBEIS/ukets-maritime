...
AS (
SELECT account_id, reporting_year, "imoNumber" imoShip, "portDetails"->> 'ccs' ccs, "portDetails"->> 'ccu' ccu,
CASE "portDetails"->> 'smallIslandFerryReduction' WHEN 'true' THEN 'Yes' ELSE 'No' END ferryDeduction,
...
ccs "Carbon capture and storage (CCS)", ccu "Carbon capture and utilisation (CCU)", ferryDeduction "Small island deduction",
