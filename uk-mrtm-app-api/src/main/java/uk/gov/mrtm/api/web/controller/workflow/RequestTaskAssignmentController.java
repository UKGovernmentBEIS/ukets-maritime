...
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.REQUEST_TASK_ASSIGNMENT_BAD_REQUEST;
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.REQUEST_TASK_CANDIDATE_ASSIGNEES_BAD_REQUEST;
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.REQUEST_TASK_TYPE_CANDIDATE_ASSIGNEES_BAD_REQUEST;
...
public class RequestTaskAssignmentController {
    ...
    @ApiResponse(responseCode = "400", description = REQUEST_TASK_ASSIGNMENT_BAD_REQUEST,
    ...
    @ApiResponse(responseCode = "200", description = OK,
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = AssigneeUserInfoDTO.class))))
    @ApiResponse(responseCode = "400", description = REQUEST_TASK_CANDIDATE_ASSIGNEES_BAD_REQUEST,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
    @ApiResponse(responseCode = "403", description = FORBIDDEN,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
    @ApiResponse(responseCode = "404", description = NOT_FOUND,
    ...
    @ApiResponse(responseCode = "200", description = OK,
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = AssigneeUserInfoDTO.class))))
    @ApiResponse(responseCode = "400", description = REQUEST_TASK_TYPE_CANDIDATE_ASSIGNEES_BAD_REQUEST,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
    @ApiResponse(responseCode = "403", description = FORBIDDEN,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
    @ApiResponse(responseCode = "429", description = SwaggerApiInfo.TOO_MANY_REQUESTS,
