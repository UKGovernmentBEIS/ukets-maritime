...
public class DoeApplicationPeerReviewInitializerRequestTaskHandler implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return DOE_MAPPER.toDoeApplicationSubmitRequestTaskPayload(requestPayload,
                        MrtmRequestTaskPayloadType.DOE_APPLICATION_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.DOE_APPLICATION_PEER_REVIEW);
    }
