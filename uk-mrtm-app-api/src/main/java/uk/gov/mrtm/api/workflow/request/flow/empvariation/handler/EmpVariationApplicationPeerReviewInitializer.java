...
public class EmpVariationApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return EMP_VARIATION_REVIEW_MAPPER.toEmpVariationApplicationReviewRequestTaskPayload(
                requestPayload, MrtmRequestTaskPayloadType.EMP_VARIATION_APPLICATION_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public  Set<String>  getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.EMP_VARIATION_APPLICATION_PEER_REVIEW);
    }
}
