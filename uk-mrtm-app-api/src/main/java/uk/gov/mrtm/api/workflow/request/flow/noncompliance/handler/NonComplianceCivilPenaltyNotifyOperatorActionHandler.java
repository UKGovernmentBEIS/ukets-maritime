...
public class NonComplianceCivilPenaltyNotifyOperatorActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        final NonComplianceCivilPenaltyApplicationSubmittedRequestActionPayload actionPayload =
            NON_COMPLIANCE_MAPPER.toCivilPenaltySubmittedRequestAction(taskPayload, decisionNotification, usersInfo,
                MrtmRequestActionPayloadType.NON_COMPLIANCE_CIVIL_PENALTY_APPLICATION_SUBMITTED_PAYLOAD);
        ...
        // send email
        officialNoticeService.sendOfficialNotice(taskPayload.getCivilPenalty(), request, decisionNotification);
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_CIVIL_PENALTY_NOTIFY_OPERATOR);
    }
}
