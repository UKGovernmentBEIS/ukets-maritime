...
public class EmissionsMonitoringPlanViolation {
    ...
    public enum ViolationMessage {
        ...
        INVALID_REGISTERED_OWNER_IMO_NUMBER_MATCH_ACCOUNT_IMO_NUMBER("Registered owner IMO number should not match company IMO number"),
        INVALID_REGISTERED_OWNER_IMO_NUMBER_MATCH_SHIP_IMO_NUMBER("Registered owner IMO number should not match ship IMO number"),
        ...
        INVALID_ISM_SHIPS_AND_REGISTERED_OWNERS("The list of ships includes ships where the nature of responsibility lies with the ISM company, and no registered owner has been added. All relevant ships must be associated with a registered owner."),
