...
@Service
public class NonComplianceInitialPenaltyNoticeApplicationSubmittedCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(final RequestAction requestAction) {
        ...
        final NonComplianceInitialPenaltyNoticeApplicationSubmittedRequestActionPayload actionPayload =
            (NonComplianceInitialPenaltyNoticeApplicationSubmittedRequestActionPayload) requestAction.getPayload();

        final RequestActionDTO requestActionDTO = requestActionMapper.toRequestActionDTOIgnorePayload(requestAction);

        final NonComplianceInitialPenaltyNoticeApplicationSubmittedRequestActionPayload dtoPayload =
            NON_COMPLIANCE_MAPPER.toInitialPenaltyNoticeSubmittedRequestActionIgnoreComments(actionPayload);
    ...
    public String getRequestActionType() {
        return MrtmRequestActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_APPLICATION_SUBMITTED;
    }
