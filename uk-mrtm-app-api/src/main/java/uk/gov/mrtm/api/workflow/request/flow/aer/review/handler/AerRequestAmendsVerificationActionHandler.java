...
@Component
public class AerRequestAmendsVerificationActionHandler
    ...
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType, AppUser appUser,
        ...
        requestAerReviewService.sendAmendedAerToVerifier(requestTask, appUser);
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.AER_REQUEST_AMENDS_VERIFICATION);
    }
}
