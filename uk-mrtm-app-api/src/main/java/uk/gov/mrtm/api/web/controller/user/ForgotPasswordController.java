...
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.REQUEST_RESET_PASSWORD_BAD_REQUEST;
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.RESET_PASSWORD_BAD_REQUEST;
import static uk.gov.mrtm.api.web.constants.SwaggerApiInfo.TOKEN_VERIFICATION_BAD_REQUEST;
...
public class ForgotPasswordController {
    ...
    @ApiResponse(responseCode = "200", description = OK,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EmailDTO.class))})
    @ApiResponse(responseCode = "400", description = TOKEN_VERIFICATION_BAD_REQUEST,
    ...
    @ApiResponse(responseCode = "204", description = NO_CONTENT)
    @ApiResponse(responseCode = "400", description = RESET_PASSWORD_BAD_REQUEST,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
    @ApiResponse(responseCode = "500", description = INTERNAL_SERVER_ERROR,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
