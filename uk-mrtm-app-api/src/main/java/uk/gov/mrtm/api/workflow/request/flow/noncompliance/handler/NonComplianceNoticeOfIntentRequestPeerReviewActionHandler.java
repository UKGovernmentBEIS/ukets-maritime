...
public class NonComplianceNoticeOfIntentRequestPeerReviewActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        workflowService.completeTask(
                ...
                Map.of(
                        ...
                        BpmnProcessConstants.REQUEST_TYPE_DYNAMIC_TASK_PREFIX, MrtmRequestCustomContext.NON_COMPLIANCE_NOTICE_OF_INTENT.getCode()
                )
        );
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_REQUEST_PEER_REVIEW);
    }
}
