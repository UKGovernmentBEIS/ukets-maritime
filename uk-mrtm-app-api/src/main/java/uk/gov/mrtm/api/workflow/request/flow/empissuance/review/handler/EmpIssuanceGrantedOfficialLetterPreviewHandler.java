...
@Service
public class EmpIssuanceGrantedOfficialLetterPreviewHandler extends EmpIssuanceOfficialLetterPreviewHandler {

    private final FileDocumentGenerateServiceDelegator fileDocumentGenerateServiceDelegator;

    public EmpIssuanceGrantedOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<String> getTypes() {
        return List.of(MrtmDocumentTemplateType.EMP_ISSUANCE_GRANTED);
    }
