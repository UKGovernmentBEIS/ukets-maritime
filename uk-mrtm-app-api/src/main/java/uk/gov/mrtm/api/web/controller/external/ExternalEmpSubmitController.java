...
public class ExternalEmpSubmitController {

    private final ExternalEmpSubmitService externalEmpSubmitService;

    @PutMapping(path = "/{company-imo-number}/emp", consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Saves or updates maritime emissions monitoring plan data into the staging area. Data can be imported via the Maritime website.")
    ...
    public ResponseEntity<Void> submitEmissionsMonitoringPlanData(
        ...
        externalEmpSubmitService.submitEmissionsMonitoringPlanData(emissionsMonitoringPlan,  companyImoNumber, appUser);
