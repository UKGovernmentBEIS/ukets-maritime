...
public class NonComplianceCivilPenaltyRequestPeerReviewActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        workflowService.completeTask(
            ...
            Map.of(
                ...
                BpmnProcessConstants.REQUEST_TYPE_DYNAMIC_TASK_PREFIX, MrtmRequestCustomContext.NON_COMPLIANCE_CIVIL_PENALTY.getCode()
            )
        );
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_CIVIL_PENALTY_REQUEST_PEER_REVIEW);
    }
}
