...
public class NonComplianceNoticeOfIntentWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return NON_COMPLIANCE_MAPPER.toNonComplianceNoticeOfIntentRequestTaskPayload(
            requestPayload,
            MrtmRequestTaskPayloadType.NON_COMPLIANCE_NOTICE_OF_INTENT_WAIT_FOR_PEER_REVIEW_PAYLOAD
        );
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.NON_COMPLIANCE_NOTICE_OF_INTENT_WAIT_FOR_PEER_REVIEW);
    }
}
