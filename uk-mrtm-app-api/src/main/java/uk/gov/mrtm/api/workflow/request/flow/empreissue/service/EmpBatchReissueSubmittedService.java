...
public class EmpBatchReissueSubmittedService {
    ...
    public void batchReissueSubmitted(final String requestId) {
        ...
        final EmpBatchReissueRequestMetadata batchRequestMetadata = (EmpBatchReissueRequestMetadata) request.getMetadata();
        final String signatoryName = requestActionUserInfoResolver.getUserFullName(requestPayload.getSignatory());

        final EmpBatchReissueSubmittedRequestActionPayload actionPayload = BATCH_REISSUE_MAPPER
                .toSubmittedActionPayload(requestPayload, batchRequestMetadata, signatoryName,
                        MrtmRequestActionPayloadType.EMP_BATCH_REISSUE_SUBMITTED_PAYLOAD);
        ...
        requestService.addActionToRequest(request,
                actionPayload,
                MrtmRequestActionType.EMP_BATCH_REISSUE_SUBMITTED,
