...
@Service
public class EmpVariationApplicationDeemedWithdrawnCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(RequestAction requestAction) {
        EmpVariationApplicationDeemedWithdrawnRequestActionPayload requestActionPayload =
            (EmpVariationApplicationDeemedWithdrawnRequestActionPayload) requestAction.getPayload();
        ...
        EmpVariationApplicationDeemedWithdrawnRequestActionPayload clonedRequestActionPayload =
        		EMP_VARIATION_REVIEW_REQUEST_ACTION_MAPPER.cloneDeemedWithdrawnPayloadIgnoreReason(requestActionPayload);
    ...
    public String getRequestActionType() {
        return MrtmRequestActionType.EMP_VARIATION_APPLICATION_DEEMED_WITHDRAWN;
    }
