...
@Service
public class EmpNotificationWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.EMP_NOTIFICATION_WAIT_FOR_PEER_REVIEW);
    }
}
