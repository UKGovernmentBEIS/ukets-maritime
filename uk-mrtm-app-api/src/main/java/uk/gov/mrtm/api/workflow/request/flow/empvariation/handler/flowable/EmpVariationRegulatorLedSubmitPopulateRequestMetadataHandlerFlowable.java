...
public class EmpVariationRegulatorLedSubmitPopulateRequestMetadataHandlerFlowable implements JavaDelegate {

    private final EmpVariationPopulateRequestMetadataService service;

    @Override
    public void execute(DelegateExecution execution) {
        service.populateRequestMetadata((String) execution.getVariable(BpmnProcessConstants.REQUEST_ID), true);
    }
}
