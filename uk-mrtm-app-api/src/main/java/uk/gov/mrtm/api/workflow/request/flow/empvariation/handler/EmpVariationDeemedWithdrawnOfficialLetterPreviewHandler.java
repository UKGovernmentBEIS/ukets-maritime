...
@Service
public class EmpVariationDeemedWithdrawnOfficialLetterPreviewHandler extends PreviewDocumentAbstractHandler {
    ...
    public EmpVariationDeemedWithdrawnOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<String> getTypes() {
        return List.of(MrtmDocumentTemplateType.EMP_VARIATION_DEEMED_WITHDRAWN);
    }
