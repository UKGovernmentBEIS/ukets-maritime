...
@Service
public class EmpNotificationApplicationReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        return empNotificationMapper.toApplicationReviewRequestTaskPayload(
                ...
                MrtmRequestTaskPayloadType.EMP_NOTIFICATION_APPLICATION_REVIEW_PAYLOAD
        );
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.EMP_NOTIFICATION_APPLICATION_REVIEW);
    }
}
