...
public class EmpVariationSaveReviewGroupDecisionActionHandler
        implements RequestTaskActionHandler<EmpVariationSaveReviewGroupDecisionRequestTaskActionPayload> {
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.EMP_VARIATION_SAVE_REVIEW_GROUP_DECISION);
    }
}
