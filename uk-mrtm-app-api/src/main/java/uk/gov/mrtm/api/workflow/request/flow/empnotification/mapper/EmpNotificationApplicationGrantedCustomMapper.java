...
@Service
public class EmpNotificationApplicationGrantedCustomMapper implements RequestActionCustomMapper {
    ...
    public String getRequestActionType() {
        return MrtmRequestActionType.EMP_NOTIFICATION_APPLICATION_GRANTED;
    }
