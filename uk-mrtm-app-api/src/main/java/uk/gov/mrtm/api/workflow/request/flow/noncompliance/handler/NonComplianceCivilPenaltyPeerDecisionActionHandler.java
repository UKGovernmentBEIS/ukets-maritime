...
public class NonComplianceCivilPenaltyPeerDecisionActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                MrtmRequestActionPayloadType.NON_COMPLIANCE_CIVIL_PENALTY_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final String type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            MrtmRequestActionType.NON_COMPLIANCE_CIVIL_PENALTY_PEER_REVIEWER_ACCEPTED :
            MrtmRequestActionType.NON_COMPLIANCE_CIVIL_PENALTY_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_CIVIL_PENALTY_SUBMIT_PEER_REVIEW_DECISION);
    }
}
