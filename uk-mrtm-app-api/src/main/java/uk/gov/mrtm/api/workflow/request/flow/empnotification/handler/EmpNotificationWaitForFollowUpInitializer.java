...
@Service
public class EmpNotificationWaitForFollowUpInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return EmpNotificationWaitForFollowUpRequestTaskPayload.builder()
    ...
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.EMP_NOTIFICATION_WAIT_FOR_FOLLOW_UP);
    }
}
