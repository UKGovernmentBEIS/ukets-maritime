...
public class AccountExemptSendToRegistryProducer {

    private final String topicName;

    public AccountExemptSendToRegistryProducer(
        @Value("${kafka.maritime.account-exempt-request.topic}") String topicName) {
        this.topicName = topicName;
    }

    @Transactional
    public void produce(AccountExemptionUpdateEvent event,
                        KafkaTemplate<String, AccountExemptionUpdateEvent> kafkaTemplate) {
        try {
