...
@Component
public class EmpVariationSaveActionHandler implements RequestTaskActionHandler<EmpVariationSaveApplicationRequestTaskActionPayload> {
	...
	public List<String> getTypes() {
		return List.of(MrtmRequestTaskActionType.EMP_VARIATION_SAVE_APPLICATION);
	}
