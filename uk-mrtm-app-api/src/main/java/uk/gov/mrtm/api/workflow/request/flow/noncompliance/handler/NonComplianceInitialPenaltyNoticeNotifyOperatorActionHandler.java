...
public class NonComplianceInitialPenaltyNoticeNotifyOperatorActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        final NonComplianceInitialPenaltyNoticeApplicationSubmittedRequestActionPayload actionPayload =
            NON_COMPLIANCE_MAPPER.toInitialPenaltyNoticeSubmittedRequestAction(taskPayload, decisionNotification, usersInfo,
                MrtmRequestActionPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_APPLICATION_SUBMITTED_PAYLOAD);
        ...
        // send email
        sendOfficialNoticeService.sendOfficialNotice(taskPayload.getInitialPenaltyNotice(), request, decisionNotification);
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_NOTIFY_OPERATOR);
    }
}
