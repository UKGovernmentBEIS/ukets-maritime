...
public class NonComplianceInitialPenaltyNoticePeerDecisionActionHandler
    ...
    public RequestTaskPayload process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                MrtmRequestActionPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final String type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            MrtmRequestActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_PEER_REVIEWER_ACCEPTED :
            MrtmRequestActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_SUBMIT_PEER_REVIEW_DECISION);
    }
}
