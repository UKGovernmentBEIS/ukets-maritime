...
public class NonComplianceInitialPenaltyNoticeInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return NON_COMPLIANCE_MAPPER.toNonComplianceInitialPenaltyNoticeRequestTaskPayload(
            requestPayload,
            MrtmRequestTaskPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_PAYLOAD
        );
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE);
    }
}
