...
public class ExternalAerController {
    ...
    @Operation(summary = "Saves or updates maritime annual emissions report data into the staging area. Data can be imported via the Maritime website. This endpoint will be available from 1 July 2026 in production environment")
