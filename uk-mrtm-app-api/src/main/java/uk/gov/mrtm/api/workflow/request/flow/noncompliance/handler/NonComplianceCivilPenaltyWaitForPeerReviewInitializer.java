...
public class NonComplianceCivilPenaltyWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return NON_COMPLIANCE_MAPPER.toNonComplianceCivilPenaltyRequestTaskPayload(
            requestPayload,
            MrtmRequestTaskPayloadType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW_PAYLOAD
        );
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW);
    }
}
