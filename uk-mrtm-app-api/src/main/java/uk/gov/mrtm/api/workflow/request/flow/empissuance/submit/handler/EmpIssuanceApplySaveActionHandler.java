...
public class EmpIssuanceApplySaveActionHandler implements RequestTaskActionHandler<EmpIssuanceSaveApplicationRequestTaskActionPayload> {

    private final RequestEmpService requestEmpService;
    private final RequestTaskService requestTaskService;

    @Override
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType, AppUser appUser, EmpIssuanceSaveApplicationRequestTaskActionPayload payload) {
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.EMP_ISSUANCE_SAVE_APPLICATION);
    }
}
