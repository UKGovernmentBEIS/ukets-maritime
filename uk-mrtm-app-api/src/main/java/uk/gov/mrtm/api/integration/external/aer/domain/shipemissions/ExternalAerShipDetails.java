...
public class ExternalAerShipDetails {
    ...
    @Schema(nullable = true, description = "Start date of the period. Required only when 'allYear' is false, otherwise must be omitted")
    private LocalDate from;

    @Schema(nullable = true, description = "End date of the period. Required only when 'allYear' is false, otherwise must be omitted")
