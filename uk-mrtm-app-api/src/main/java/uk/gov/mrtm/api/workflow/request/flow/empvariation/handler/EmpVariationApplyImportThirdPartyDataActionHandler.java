...
public class EmpVariationApplyImportThirdPartyDataActionHandler implements RequestTaskActionHandler<EmpVariationSaveApplicationRequestTaskActionPayload> {
    ...
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType, AppUser appUser,
        ...
        empVariationSubmitService.saveEmpVariation(payload, requestTask);
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.EMP_VARIATION_IMPORT_THIRD_PARTY_DATA_APPLICATION);
    }
}
