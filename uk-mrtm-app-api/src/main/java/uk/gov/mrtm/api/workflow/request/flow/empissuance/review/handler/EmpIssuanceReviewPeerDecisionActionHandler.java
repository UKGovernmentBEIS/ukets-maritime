...
public class EmpIssuanceReviewPeerDecisionActionHandler
    ...
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType,
        ...
        PeerReviewDecisionSubmittedRequestActionPayload requestActionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                payload,
                    MrtmRequestActionPayloadType.EMP_ISSUANCE_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        String type = payload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
                MrtmRequestActionType.EMP_ISSUANCE_APPLICATION_PEER_REVIEWER_ACCEPTED :
                MrtmRequestActionType.EMP_ISSUANCE_APPLICATION_PEER_REVIEWER_REJECTED;

        requestService.addActionToRequest(requestTask.getRequest(),
            requestActionPayload,
            type, appUser.getUserId());
    ...
    public List<String> getTypes() {
        return List.of(MrtmRequestTaskActionType.EMP_ISSUANCE_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
