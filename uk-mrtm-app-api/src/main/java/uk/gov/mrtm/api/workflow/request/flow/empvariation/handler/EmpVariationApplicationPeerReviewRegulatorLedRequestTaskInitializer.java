...
public class EmpVariationApplicationPeerReviewRegulatorLedRequestTaskInitializer implements InitializeRequestTaskHandler {
	...
	public RequestTaskPayload initializePayload(Request request) {
        ...
        return MAPPER.toEmpVariationApplicationSubmitRegulatorLedRequestTaskPayload(
                requestPayload, MrtmRequestTaskPayloadType.EMP_VARIATION_APPLICATION_PEER_REVIEW_REGULATOR_LED_PAYLOAD
            );
	}

	@Override
	public Set<String> getRequestTaskTypes() {
		return Set.of(MrtmRequestTaskType.EMP_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEW);
	}
