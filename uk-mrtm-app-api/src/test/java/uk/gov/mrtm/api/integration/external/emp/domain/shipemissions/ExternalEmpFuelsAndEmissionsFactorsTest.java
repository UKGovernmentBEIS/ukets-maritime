...
class ExternalEmpFuelsAndEmissionsFactorsTest {
    ...
    void when_fuel_origin_is_fossil() {
        final ExternalEmpFuelsAndEmissionsFactors empCarbonCapture = ExternalEmpFuelsAndEmissionsFactors.builder()
            ...
            .methodDensityBunkerCode(DensityMethodBunker.NA)
            .methodDensityTankCode(DensityMethodTank.NA)
            .build();

        final Set<ConstraintViolation<ExternalEmpFuelsAndEmissionsFactors>> violations = validator.validate(empCarbonCapture);
    ...
    void validate_emp_fossil_fuels_and_emission_factors_valid(ExternalFuelType type,
        ...
        final ExternalEmpFuelsAndEmissionsFactors emissionsFactors = ExternalEmpFuelsAndEmissionsFactors.builder()
            .fuelTypeCode(type)
            .fuelOriginCode(FuelOrigin.FOSSIL)
            .otherFuelType(name)
            ...
            .methodDensityBunkerCode(DensityMethodBunker.FUEL_SUPPLIER)
            .methodDensityTankCode(DensityMethodTank.MEASUREMENT_SYSTEMS)
            .build();

        final Set<ConstraintViolation<ExternalEmpFuelsAndEmissionsFactors>> violations = validator.validate(emissionsFactors);
    ...
    void validate_emp_e_fuels_and_emission_factors_valid(ExternalFuelType type,
        ...
        final ExternalEmpFuelsAndEmissionsFactors empShipDetails = ExternalEmpFuelsAndEmissionsFactors.builder()
            .fuelTypeCode(type)
        ...
        final Set<ConstraintViolation<ExternalEmpFuelsAndEmissionsFactors>> violations = validator.validate(empShipDetails);
