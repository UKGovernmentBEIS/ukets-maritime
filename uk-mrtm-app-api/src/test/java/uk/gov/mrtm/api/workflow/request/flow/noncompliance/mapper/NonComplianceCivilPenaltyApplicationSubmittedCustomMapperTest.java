...
class NonComplianceCivilPenaltyApplicationSubmittedCustomMapperTest {
    ...
    void toRequestActionDTO() {
        ...
        final RequestAction requestAction = RequestAction.builder()
            .type(MrtmRequestActionType.NON_COMPLIANCE_CIVIL_PENALTY_APPLICATION_SUBMITTED)
    ...
    void getRequestActionType() {
        assertThat(mapper.getRequestActionType()).isEqualTo(MrtmRequestActionType.NON_COMPLIANCE_CIVIL_PENALTY_APPLICATION_SUBMITTED);
    }
