...
class EmpVariationDeemedWithdrawnAddRequestActionHandlerTest {

    @InjectMocks
    private EmpVariationDeemedWithdrawnAddRequestActionHandler handler;

    @Mock
    private EmpVariationDeemedWithdrawnAddRequestActionService service;
