...
class NonComplianceNoticeOfIntentWaitForPeerReviewInitializerTest {
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NonComplianceNoticeOfIntentRequestTaskPayload.builder()
            .payloadType(MrtmRequestTaskPayloadType.NON_COMPLIANCE_NOTICE_OF_INTENT_WAIT_FOR_PEER_REVIEW_PAYLOAD)
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
            .containsExactlyInAnyOrder(MrtmRequestTaskType.NON_COMPLIANCE_NOTICE_OF_INTENT_WAIT_FOR_PEER_REVIEW);
    }
}
