...
class NonComplianceInitialPenaltyNoticeRequestPeerReviewActionHandlerTest {
    @InjectMocks
    private NonComplianceInitialPenaltyNoticeRequestPeerReviewActionHandler handler;
    ...
    void process() {
        ...
        final NonComplianceInitialPenaltyNoticeRequestTaskPayload taskPayload =
            NonComplianceInitialPenaltyNoticeRequestTaskPayload.builder()
                .payloadType(MrtmRequestTaskPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_APPLICATION_PEER_REVIEW_PAYLOAD)
                .build();
        final NonComplianceInitialPenaltyNoticeRequestTaskPayload expectedTaskPayload =
            NonComplianceInitialPenaltyNoticeRequestTaskPayload.builder()
                .payloadType(MrtmRequestTaskPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_APPLICATION_PEER_REVIEW_PAYLOAD)
                .build();
        ...
        RequestTaskPayload actualTaskPayload = handler.process(
            requestTaskId,
            MrtmRequestTaskActionType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_REQUEST_PEER_REVIEW,
            appUser,
            taskActionPayload);
        ...
        verify(workflowService, times(1)).completeTask(
            ...
            Map.of(
                ...
                MrtmRequestCustomContext.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE.getCode()
            )
        );
    }
