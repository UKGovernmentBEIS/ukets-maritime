...
class EmpVariationUploadAttachmentServiceTest {

    @InjectMocks
    private EmpVariationUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(EmpVariationApplicationSubmitRequestTaskPayload.builder().build())
            .build();
