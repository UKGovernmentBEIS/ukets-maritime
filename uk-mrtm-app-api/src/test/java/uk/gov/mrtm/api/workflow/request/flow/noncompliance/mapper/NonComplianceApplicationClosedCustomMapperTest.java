...
class NonComplianceApplicationClosedCustomMapperTest {

    @InjectMocks
    private NonComplianceApplicationClosedCustomMapper mapper;

    @Test
    void toRequestActionDTO() {

        final RequestAction requestAction = RequestAction.builder()
            .type(MrtmRequestActionType.NON_COMPLIANCE_APPLICATION_CLOSED)
        ...
        assertThat(resultPayload).isNull();
    }

    @Test
    void getRequestActionType() {
        assertThat(mapper.getRequestActionType()).isEqualTo(MrtmRequestActionType.NON_COMPLIANCE_APPLICATION_CLOSED);
    }
