...
class ExemptionConditionsTest {
    ...
    void validate_exemption_conditions_exist_valid() {
        ...
        final ExemptionConditions exemptionConditions = ExemptionConditions.builder()
                .exist(Boolean.TRUE)
                .minVoyages(301)
                .build();

        final Set<ConstraintViolation<ExemptionConditions>> violations = validator.validate(exemptionConditions);
    ...
    void validate_exemption_conditions_not_exist_invalid() {
        ...
        assertThat(violations)
                ...
                .containsOnly("{emp.emission.exemptionconditions.exist}");
    }
