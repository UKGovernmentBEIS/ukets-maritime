...
public class EmpVariationRegulatorLedSubmitPopulateRequestMetadataHandlerFlowableTest {

    @InjectMocks
    private EmpVariationRegulatorLedSubmitPopulateRequestMetadataHandlerFlowable cut;
    ...
    void execute() throws Exception {
        ...
        verify(service, times(1)).populateRequestMetadata(requestId, true);
    }
}
