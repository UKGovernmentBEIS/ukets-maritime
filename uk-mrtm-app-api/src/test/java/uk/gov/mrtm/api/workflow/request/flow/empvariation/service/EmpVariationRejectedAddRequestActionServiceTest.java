...
class EmpVariationRejectedAddRequestActionServiceTest {

    @InjectMocks
    private EmpVariationRejectedAddRequestActionService addRequestActionService;
    ...
    void addRequestAction() {
        ...
        EmpVariationApplicationRejectedRequestActionPayload requestActionPayload = EmpVariationApplicationRejectedRequestActionPayload.builder()
                .payloadType(MrtmRequestActionPayloadType.EMP_VARIATION_APPLICATION_REJECTED_PAYLOAD)
                .determination(determination)
                .decisionNotification(decisionNotification)
                .usersInfo(usersInfo)
                .originalEmpContainer(originalEmpContainer)
        ...
        verify(requestService, times(1))
                .addActionToRequest(request, requestActionPayload,  MrtmRequestActionType.EMP_VARIATION_APPLICATION_REJECTED, regulatorUser);
    }
}
