...
class EmpNotificationFollowUpInitializerTest {

    @InjectMocks
    private EmpNotificationFollowUpInitializer initializer;
    ...
    void initializePayload() {
        ...
        final EmpNotificationFollowUpRequestTaskPayload expected =
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
                .isEqualTo(Set.of(MrtmRequestTaskType.EMP_NOTIFICATION_FOLLOW_UP));
    }
}
