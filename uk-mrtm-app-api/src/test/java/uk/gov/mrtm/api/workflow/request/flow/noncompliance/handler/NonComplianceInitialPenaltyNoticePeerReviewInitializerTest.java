...
class NonComplianceInitialPenaltyNoticePeerReviewInitializerTest {

    @InjectMocks
    private NonComplianceInitialPenaltyNoticePeerReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactlyInAnyOrder(
            MrtmRequestTaskType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_APPLICATION_PEER_REVIEW);
    }
