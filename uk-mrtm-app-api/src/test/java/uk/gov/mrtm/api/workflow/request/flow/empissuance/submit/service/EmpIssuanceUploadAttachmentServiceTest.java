...
class EmpIssuanceUploadAttachmentServiceTest {

    @InjectMocks
    private EmpIssuanceUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(EmpIssuanceApplicationSubmitRequestTaskPayload.builder().build())
                .build();
