...
class EmpIssuanceReviewPeerDecisionActionHandlerTest {

    @InjectMocks
    private EmpIssuanceReviewPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(MrtmRequestTaskActionPayloadTypes.EMP_ISSUANCE_REVIEW_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        RequestTaskPayload requestTaskPayload = handler.process(requestTask.getId(),
            MrtmRequestTaskActionType.EMP_ISSUANCE_REVIEW_SUBMIT_PEER_REVIEW_DECISION,
            appUser,
            payload);
        ...
        verify(requestService, times(1)).addActionToRequest(
            ...
            eq(MrtmRequestActionType.EMP_ISSUANCE_APPLICATION_PEER_REVIEWER_REJECTED),
            eq(userId));
        ...
        assertThat(captorValue.getPayloadType())
            .isEqualTo(MrtmRequestActionPayloadType.EMP_ISSUANCE_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes())
            .containsExactly(MrtmRequestTaskActionType.EMP_ISSUANCE_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}