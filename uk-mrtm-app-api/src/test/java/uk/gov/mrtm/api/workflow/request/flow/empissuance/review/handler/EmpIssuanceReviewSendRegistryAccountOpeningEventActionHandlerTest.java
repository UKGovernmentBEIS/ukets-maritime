...
class EmpIssuanceReviewSendRegistryAccountOpeningEventActionHandlerTest {
    ...
    void process_isAccountOpeningEventSentToRegistry_false() {
        ...
        verify(addRequestActionService).addRequestAction(
            ...
            userId);
        verify(accountCreatedEventListenerResolver).onAccountCreatedEvent(EmpApprovedEvent.builder()
            .accountId(requestTask.getRequest().getAccountId())
            .emissionsMonitoringPlan(emissionsMonitoringPlan)
            .build());

        verifyNoMoreInteractions(accountCreatedEventListenerResolver, requestTaskService, addRequestActionService);
    }
    ...
    void process_isAccountOpeningEventSentToRegistry_true() {
        ...
        verifyNoInteractions(accountCreatedEventListenerResolver, addRequestActionService);
    }
