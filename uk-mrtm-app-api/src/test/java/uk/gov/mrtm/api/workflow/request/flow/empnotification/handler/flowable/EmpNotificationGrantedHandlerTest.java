...
class EmpNotificationGrantedHandlerTest {

    @InjectMocks
    private EmpNotificationGrantedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(reviewSubmittedService).executeGrantedPostActions(requestId);
        verify(reviewSubmittedService).isFollowUpNeeded(requestId);
