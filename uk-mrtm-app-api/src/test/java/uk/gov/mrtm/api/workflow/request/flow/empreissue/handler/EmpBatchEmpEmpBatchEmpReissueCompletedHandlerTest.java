...
class EmpBatchEmpEmpBatchEmpReissueCompletedHandlerTest {
    ...
    void execute() throws Exception {
        ...
        when(execution.getVariable(MrtmBpmnProcessConstants.EMP_REISSUE_REQUEST_ID)).thenReturn(reissueRequestId);
        ...
        verify(execution, times(1)).getVariable(MrtmBpmnProcessConstants.EMP_REISSUE_REQUEST_ID);
