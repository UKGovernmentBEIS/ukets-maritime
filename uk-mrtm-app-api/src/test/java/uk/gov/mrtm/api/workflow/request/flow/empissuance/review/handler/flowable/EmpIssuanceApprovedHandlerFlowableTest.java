...
class EmpIssuanceApprovedHandlerFlowableTest {

    @InjectMocks
    private EmpIssuanceApprovedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(empIssuanceApprovedService, times(1)).approveEmp(requestId);
        verifyNoMoreInteractions(empIssuanceApprovedService);
    }
}
