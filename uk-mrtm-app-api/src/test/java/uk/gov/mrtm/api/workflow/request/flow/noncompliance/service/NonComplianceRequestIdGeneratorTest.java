...
class NonComplianceRequestIdGeneratorTest {
    ...
    @Test
    void getTypes() {
        assertThat(generator.getTypes()).containsExactly(MrtmRequestType.NON_COMPLIANCE);
    }

    @Test
    void getPrefix() {
        assertThat(generator.getPrefix()).isEqualTo("MANC");
    }
    ...
    void generate() {
        ...
        RequestType requestType = RequestType.builder().code(MrtmRequestType.NON_COMPLIANCE).build();
        ...
        when(requestTypeRepository.findByCode(MrtmRequestType.NON_COMPLIANCE)).thenReturn(Optional.of(requestType));

        String result = generator.generate(params);

        assertThat(result).isEqualTo("MANC" + "00100" + "-" + (currentSequence + 1));
        ...
        verify(requestTypeRepository).findByCode(MrtmRequestType.NON_COMPLIANCE);
