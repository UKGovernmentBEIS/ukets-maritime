...
class EmpIssuanceApplySaveActionHandlerTest {

    @InjectMocks
    private EmpIssuanceApplySaveActionHandler handler;
    ...
    void process() {
        ...
        EmpIssuanceSaveApplicationRequestTaskActionPayload requestTaskActionPayload =
                EmpIssuanceSaveApplicationRequestTaskActionPayload.builder()
                        .payloadType(MrtmRequestTaskActionType.EMP_ISSUANCE_SAVE_APPLICATION)
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsOnly(MrtmRequestTaskActionType.EMP_ISSUANCE_SAVE_APPLICATION);
    }
}
