...
class NonComplianceCivilPenaltyWaitForPeerReviewInitializerTest {
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NonComplianceCivilPenaltyRequestTaskPayload.builder()
            .payloadType(MrtmRequestTaskPayloadType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW_PAYLOAD)
            .civilPenalty(civilPenalty)
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactlyInAnyOrder(
            MrtmRequestTaskType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW);
    }
