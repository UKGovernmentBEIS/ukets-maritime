...
class EmpVariationApprovedAddRequestActionHandlerFlowableTest {

    @InjectMocks
    private EmpVariationApprovedAddRequestActionHandlerFlowable handler;

    @Mock
    private EmpVariationApprovedAddRequestActionService service;
