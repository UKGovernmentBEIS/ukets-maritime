...
class EmpIssuanceWaitForPeerReviewInitializerTest {


    @InjectMocks
    private EmpIssuanceWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(MrtmRequestTaskPayloadType.EMP_ISSUANCE_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpIssuanceApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(MrtmRequestTaskType.EMP_ISSUANCE_WAIT_FOR_PEER_REVIEW);
    }

    @Test
    void getRequestTaskPayloadType() {
        assertEquals(MrtmRequestTaskPayloadType.EMP_ISSUANCE_WAIT_FOR_PEER_REVIEW_PAYLOAD, initializer.getRequestTaskPayloadType());
    }
}