...
class OperatorAuthorityControllerTest {
    ...
    void getAccountOperatorAuthorities() throws Exception {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.contactTypes", Matchers.hasEntry(AccountContactType.PRIMARY, "primary")))
            .andExpect(jsonPath("$.contactTypes", Matchers.hasEntry(AccountContactType.SERVICE, "service")));
    ...
    void updateAccountOperatorAuthorities() throws Exception {
        ...
        Map<String, String> contactTypes = Map.of(AccountContactType.FINANCIAL, "user");
