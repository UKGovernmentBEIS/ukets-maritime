...
class DoeApplicationWaitForPeerReviewInitializerRequestTaskHandlerTest {

    @InjectMocks
    private DoeApplicationWaitForPeerReviewInitializerRequestTaskHandler cut;
    ...
    void initializePayload() {
        ...
        assertThat(result.getPayloadType()).isEqualTo(MrtmRequestTaskPayloadType.DOE_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        ...
        assertThat(result).isEqualTo(DoeApplicationSubmitRequestTaskPayload.builder()
            .payloadType(MrtmRequestTaskPayloadType.DOE_WAIT_FOR_PEER_REVIEW_PAYLOAD).doe(doe).build());
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(cut.getRequestTaskTypes()).containsExactlyInAnyOrder(
            MrtmRequestTaskType.DOE_WAIT_FOR_PEER_REVIEW);
    }
}
