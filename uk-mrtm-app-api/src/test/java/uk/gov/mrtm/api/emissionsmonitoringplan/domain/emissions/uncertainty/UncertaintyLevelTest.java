...
class UncertaintyLevelTest {
    ...
    void validate_emp_uncertainty_level_default_approach_valid() {
        ...
        final UncertaintyLevel uncertaintyLevel = UncertaintyLevel.builder()
                .monitoringMethod(BDN)
                .methodApproach(MethodApproach.DEFAULT)
                .value(BigDecimal.valueOf(7.5))
                .build();

        final Set<ConstraintViolation<UncertaintyLevel>> violations = validator.validate(uncertaintyLevel);
    ...
    void validate_emp_uncertainty_level_method_d_default_approach_invalid() {
        ...
        assertThat(violations).extracting(ConstraintViolation::getMessage)
                .containsOnly("{emp.emission.uncertaintyLevel.monitoringMethod}");
    }
    ...
    void validate_emp_uncertainty_level_default_approach_invalid() {
        ...
        assertEquals(1, violations.size());
        assertThat(violations).extracting(ConstraintViolation::getMessage)
                .containsOnly("{emp.emission.uncertaintyLevel.methodApproach}");
    }
