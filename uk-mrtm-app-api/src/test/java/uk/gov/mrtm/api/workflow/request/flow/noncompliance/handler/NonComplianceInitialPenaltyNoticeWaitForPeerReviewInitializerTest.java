...
class NonComplianceInitialPenaltyNoticeWaitForPeerReviewInitializerTest {

    @InjectMocks
    private NonComplianceInitialPenaltyNoticeWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NonComplianceInitialPenaltyNoticeRequestTaskPayload.builder()
            .payloadType(MrtmRequestTaskPayloadType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_WAIT_FOR_PEER_REVIEW_PAYLOAD)
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactlyInAnyOrder(
            MrtmRequestTaskType.NON_COMPLIANCE_INITIAL_PENALTY_NOTICE_WAIT_FOR_PEER_REVIEW);
    }
