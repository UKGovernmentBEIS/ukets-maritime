...
class EmpVariationRejectedAddRequestActionHandlerFlowableTest {

    @InjectMocks
    private EmpVariationRejectedAddRequestActionHandlerFlowable handler;

    @Mock
    private EmpVariationRejectedAddRequestActionService service;
