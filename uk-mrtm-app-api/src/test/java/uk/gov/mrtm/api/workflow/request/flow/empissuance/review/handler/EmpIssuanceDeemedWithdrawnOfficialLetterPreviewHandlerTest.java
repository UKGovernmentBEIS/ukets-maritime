...
class EmpIssuanceDeemedWithdrawnOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpIssuanceDeemedWithdrawnOfficialLetterPreviewHandler handler;
    ...
    @Test
    void getTypes() {
        assertIterableEquals(List.of(MrtmDocumentTemplateType.EMP_ISSUANCE_DEEMED_WITHDRAWN), handler.getTypes());
    }
