...
class EmpNotificationRejectedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpNotificationRejectedOfficialLetterPreviewHandler handler;
    ...
    void generateDocument() {
        ...
        final String filename = "EMP Notification Refusal Letter.pdf";
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(MrtmDocumentTemplateType.EMP_NOTIFICATION_REFUSED);
    }
