...
class AerVerificationAlreadyPerformedRequestTaskActionValidatorTest {

    @InjectMocks
    private AerVerificationAlreadyPerformedRequestTaskActionValidator validator;
    ...
    void validate_is_invalid() {
        ...
        assertThat(result).isEqualTo(RequestTaskActionValidationResult.invalidResult(
            RequestTaskActionValidationErrorCodes.VERIFIED_DATA_FOUND));
    }

    @ParameterizedTest
    @ValueSource(booleans = {true, false})
    void validate_is_valid(boolean reportingRequired) {
        RequestTask requestTask = RequestTask.builder()
            .payload(AerApplicationSubmitRequestTaskPayload.builder()
    ...
    void getErrorCode() {
        assertThat(validator.getErrorCode())
            .isEqualTo(RequestTaskActionValidationErrorCodes.VERIFIED_DATA_FOUND);
    }
}