...
class EmpVariationReviewPeerDecisionActionHandlerTest {

	@InjectMocks
    private EmpVariationReviewPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        RequestTaskPayload requestTaskPayload = handler.process(requestTask.getId(),
            MrtmRequestTaskActionType.EMP_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION,
            appUser,
            payload);
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(MrtmRequestActionPayloadType.EMP_VARIATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(MrtmRequestTaskActionType.EMP_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
