...
import { DashboardStore, initialState, selectFilters, WorkflowItemsAssignmentType } from '@shared/dashboard/+store';
import { DashboardFiltersComponent } from '@shared/dashboard/components/dashboard-filters';
import { INITIAL_FILTERS } from '@shared/dashboard/components/dashboard-filters/dashboard-filters.consts';
...
export class DashboardPageComponent {
  ...
  readonly hasAppliedFilters = computed<boolean>(() => !isEqual(this.filters(), INITIAL_FILTERS));
