...
import { empHistoryStatusMap, empHistoryTypesMap, MrtmRequestStatus, MrtmRequestType } from '@shared/types';
import { FormUtils, originalOrder } from '@shared/utils';

@Component({
  selector: 'mrtm-emissions-plan-history-tab',
  imports: [
    ReactiveFormsModule,
    CheckboxesComponent,
    CheckboxComponent,
  ...
  standalone: true,
  templateUrl: './emissions-plan-history-tab.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EmissionsPlanHistoryTabComponent {
  ...
  readonly empHistoryTypesMap = empHistoryTypesMap;
  readonly empHistoryStatusMap = empHistoryStatusMap;
