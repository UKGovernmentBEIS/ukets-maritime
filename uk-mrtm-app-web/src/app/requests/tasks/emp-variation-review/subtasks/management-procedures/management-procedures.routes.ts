...
import { canActivateManagementProceduresSummary } from '@requests/tasks/emp-variation-review/subtasks/management-procedures';
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-variation-review/subtasks/management-procedures').then(
        (c) => c.ManagementProceduresVariationReviewDecisionComponent,
      ),
  },
  {
