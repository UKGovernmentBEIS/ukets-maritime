...
import { canActivateControlActivitiesSummary } from '@requests/tasks/emp-variation-review/subtasks/control-activities';
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-variation-review/subtasks/control-activities').then(
        (c) => c.ControlActivitiesVariationReviewDecisionComponent,
      ),
  },
  {
