...
import { canActivateEmissionSourcesSummary } from '@requests/tasks/emp-variation-review/subtasks/emission-sources';
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-variation-review/subtasks/emission-sources').then(
        (c) => c.EmissionSourcesVariationReviewDecisionComponent,
      ),
  },
  {
