...
import { canActivateDataGapsSummary } from '@requests/tasks/emp-variation-review/subtasks/data-gaps';
...
export const DATA_GAPS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-variation-review/subtasks/data-gaps').then(
        (c) => c.DataGapsVariationReviewDecisionComponent,
      ),
  },
  {
    path: DataGapsWizardStep.DATA_GAPS_METHOD,
    title: dataGapsMap.dataGapsMethod.title,
    canActivate: [canActivateDataGapsStep(DataGapsWizardStep.DATA_GAPS_METHOD)],
    data: { breadcrumb: false },
    resolve: {
