...
export const nonComplianceDetailsInitialPenaltyProvider: Provider = {
  provide: TASK_FORM,
  ...
  useFactory: (formBuilder: FormBuilder, store: RequestTaskStore) => {
    ...
    return formBuilder.group({
      initialPenalty: formBuilder.control<NonComplianceSubmitTaskPayload['initialPenalty'] | null>(
        nonComplianceDetails?.initialPenalty,
