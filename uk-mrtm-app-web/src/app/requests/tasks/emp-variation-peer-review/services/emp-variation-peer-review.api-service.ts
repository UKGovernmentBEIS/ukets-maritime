...
import { EmpVariationPeerReviewTaskPayload } from '@requests/common';

export class EmpVariationPeerReviewApiService extends TaskApiService<EmpVariationPeerReviewTaskPayload> {
  ...
  public save(payload: EmpVariationPeerReviewTaskPayload): Observable<EmpVariationPeerReviewTaskPayload> {
  ...
  private createSaveAction(payload: EmpVariationPeerReviewTaskPayload): RequestTaskActionProcessDTO {
    const requestTaskId = this.store.select(requestTaskQuery.selectRequestTaskId)();

    return {
      requestTaskId,
      requestTaskActionType: 'EMP_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION',
      requestTaskActionPayload: {
        payloadType: 'EMP_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD',
