...
import { empReviewAmendsNeededGroupsProvider } from '@requests/tasks/emp-review/emp-review-amends-needed-groups.provider';
import { EmpReviewApiService, EmpReviewService } from '@requests/tasks/emp-review/services';
import { AbbreviationsDecisionPayloadMutator } from '@requests/tasks/emp-review/subtasks/abbreviations';
import { AdditionalDocumentsDecisionPayloadMutator } from '@requests/tasks/emp-review/subtasks/additional-documents';
import { ControlActivitiesDecisionPayloadMutator } from '@requests/tasks/emp-review/subtasks/control-activities';
import { DataGapsDecisionPayloadMutator } from '@requests/tasks/emp-review/subtasks/data-gaps';
import { EmissionSourcesDecisionPayloadMutator } from '@requests/tasks/emp-review/subtasks/emission-sources/emission-sources-decision';
...
import { OverallDecisionReviewSummaryPayloadMutator } from '@requests/tasks/emp-review/subtasks/overall-decision/overall-decision-review-summary/overall-decision-review-summary.payload-mutator';

export function provideEmpReviewPayloadMutators(): EnvironmentProviders {
  return makeEnvironmentProviders([
    // Abbreviations
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: AbbreviationsQuestionPayloadMutator },
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: AbbreviationsDecisionPayloadMutator },
    // Additional Documents
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: AdditionalDocumentsUploadPayloadMutator },
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: AdditionalDocumentsDecisionPayloadMutator },
    ...
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: ManagementProceduresDecisionPayloadMutator },
    // Operator Details
    ...
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: OperatorDetailsDecisionPayloadMutator },
    // Control Activities
    ...
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: ControlActivitiesDecisionPayloadMutator },
    // Data Gaps
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: DataGapsMethodPayloadMutator },
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: DataGapsDecisionPayloadMutator },
    // GreenhouseGas
    ...
    // Emissions
    ...provideEmpEmissionsSubtaskCommonPayloadMutators(),
    { provide: PAYLOAD_MUTATORS, multi: true, useClass: ListOfShipsDecisionPayloadMutator },
    // Overall Decision
...
export function provideEmpReviewTaskServices(): EnvironmentProviders {
  return makeEnvironmentProviders([
    { provide: TaskService, useClass: EmpReviewService },
    { provide: TaskApiService, useClass: EmpReviewApiService },
    { provide: RETURN_FOR_AMENDS_SERVICE, useClass: EmpReviewService },
    empReviewAmendsNeededGroupsProvider,
    empCommonSubtaskStepsProvider,
    { provide: UPLOAD_SHIPS_XML_SERVICE, useClass: EmpShipsXmlService },
  ]);
}

export function provideEmpReviewSideEffects(): EnvironmentProviders {
  return makeEnvironmentProviders([
...
export function provideEmpReviewStepFlowManagers(): EnvironmentProviders {
  return makeEnvironmentProviders([
