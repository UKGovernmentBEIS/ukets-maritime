...
import { canActivateAbbreviationsSummary } from '@requests/tasks/emp-review/subtasks/abbreviations';
...
export const ABBREVIATIONS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-review/subtasks/abbreviations').then((c) => c.AbbreviationsDecisionComponent),
  },
  {
