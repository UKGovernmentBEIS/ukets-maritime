...
import { canActivateGreenhouseGasSummary } from '@requests/tasks/emp-review/subtasks/greenhouse-gas';
...
export const GREENHOUSE_GAS_ROUTES: Route[] = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-review/subtasks/greenhouse-gas').then((c) => c.GreenhouseGasDecisionComponent),
  },
  {
