...
import { canActivateOperatorDetailsSummary } from '@requests/tasks/emp-review/subtasks/operator-details';
...
export const OPERATOR_DETAILS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-review/subtasks/operator-details').then((c) => c.OperatorDetailsDecisionComponent),
  },
  {
