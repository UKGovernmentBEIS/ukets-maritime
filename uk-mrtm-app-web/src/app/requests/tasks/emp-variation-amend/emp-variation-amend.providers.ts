...
export function provideEmpVariationAmendPayloadMutators(): EnvironmentProviders {
...
export function provideEmpVariationAmendTaskServices(): EnvironmentProviders {
  return makeEnvironmentProviders([
    { provide: TaskService, useClass: EmpAmendVariationService },
    { provide: TaskApiService, useClass: EmpAmendVariationApiService },
    empVariationAmendsNeededGroupsProvider,
...
export function provideEmpVariationAmendStepFlowManagers(): EnvironmentProviders {
  return makeEnvironmentProviders([
