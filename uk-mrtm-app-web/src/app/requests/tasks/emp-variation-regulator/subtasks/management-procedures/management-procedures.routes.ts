...
export const MANAGEMENT_PROCEDURES_ROUTES: Routes = [
  ...
  {
    path: ManagementProceduresWizardStep.VARIATION_REGULATOR_DECISION,
    title: managementProceduresMap.variationRegulatorDecision.title,
    ...
    loadComponent: () =>
      import('@requests/tasks/emp-variation-regulator/subtasks/management-procedures').then(
        (c) => c.ManagementProceduresVariationRegulatorDecisionComponent,
      ),
  },
  {
    path: ManagementProceduresWizardStep.MONITORING_REPORTING_ROLES,
    canActivate: [canActivateManagementProceduresStep(ManagementProceduresWizardStep.VARIATION_REGULATOR_DECISION)],
