...
export const selectEmissionsReductionClaimVerification: StateSelector<
  RequestTaskState,
  AerEmissionsReductionClaimVerification
> = createDescendingSelector(selectVerificationReport, (payload) => payload?.emissionsReductionClaimVerification);
