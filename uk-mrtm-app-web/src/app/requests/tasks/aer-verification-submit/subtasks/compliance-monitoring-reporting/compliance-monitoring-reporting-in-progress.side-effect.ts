...
import { COMPLIANCE_MONITORING_REPORTING_SUB_TASK } from '@requests/common/aer';
import { AerVerificationSubmitTaskPayload } from '@requests/common/aer/aer.types';
import { TaskItemStatus } from '@requests/common/task-item-status';

export class ComplianceMonitoringReportingInProgressSideEffect extends SideEffect {
  readonly step = null;
