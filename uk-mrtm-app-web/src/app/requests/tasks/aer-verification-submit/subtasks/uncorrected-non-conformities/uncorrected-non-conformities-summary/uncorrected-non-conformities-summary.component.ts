...
import { UncorrectedNonConformitiesSummaryTemplateComponent } from '@shared/components/summaries';

@Component({
  selector: 'mrtm-uncorrected-non-conformities-summary',
  imports: [
    ButtonDirective,
...
export class UncorrectedNonConformitiesSummaryComponent {
  ...
  readonly uncorrectedNonConformities = this.store.select(aerVerificationSubmitQuery.selectUncorrectedNonConformities);
