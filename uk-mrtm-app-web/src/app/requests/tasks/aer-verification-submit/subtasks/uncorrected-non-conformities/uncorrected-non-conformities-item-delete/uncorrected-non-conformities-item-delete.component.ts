...
@Component({
  selector: 'mrtm-uncorrected-non-conformities-item-delete',
...
export class UncorrectedNonConformitiesItemDeleteComponent {
  ...
  onSubmit() {
    this.service
      .saveSubtask(this.subtask, UncorrectedNonConformitiesStep.ITEM_DELETE, this.route, {
