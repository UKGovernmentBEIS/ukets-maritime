...
import { ControlActivitiesInternalReviewsComponent } from '@requests/common/emp/subtasks/control-activities/control-activities-internal-reviews/control-activities-internal-reviews.component';
import {
...
describe('ControlActivitiesInternalReviewsComponent', () => {
  let fixture: ComponentFixture<ControlActivitiesInternalReviewsComponent>;
  let component: ControlActivitiesInternalReviewsComponent;
  let page: Page;
  let store: RequestTaskStore;

  class Page extends BasePage<ControlActivitiesInternalReviewsComponent> {
    get textboxes() {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(ControlActivitiesInternalReviewsComponent);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ControlActivitiesInternalReviewsComponent],
      providers: [
  ...
  describe('for new emission source', () => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      expect(page.heading1.textContent).toEqual('Internal reviews and validation of data');
  ...
  describe('for existing emission source', () => {
    ...
    it('should edit and submit a valid form', async () => {
      ...
      expect(taskServiceSpy).toHaveBeenCalledWith(
        CONTROL_ACTIVITIES_SUB_TASK,
        ControlActivitiesWizardStep.INTERNAL_REVIEWS,
        activatedRouteStub,
        {
          ...mockEmpProcedureForm,
