...
import {
  ...
  ControlActivitiesCorrectionsAndCorrectivesComponent,
...
describe('ControlActivitiesCorrectivesComponent', () => {
  let fixture: ComponentFixture<ControlActivitiesCorrectionsAndCorrectivesComponent>;
  let component: ControlActivitiesCorrectionsAndCorrectivesComponent;
  let page: Page;
  let store: RequestTaskStore;

  class Page extends BasePage<ControlActivitiesCorrectionsAndCorrectivesComponent> {
    get textboxes() {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ControlActivitiesCorrectionsAndCorrectivesComponent],
      providers: [
  ...
  describe('for new emission source', () => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      expect(page.heading1.textContent).toEqual('Corrections and corrective actions');
