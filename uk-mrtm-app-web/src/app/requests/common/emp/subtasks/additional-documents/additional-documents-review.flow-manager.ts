...
export class AdditionalDocumentsReviewFlowManager extends WizardFlowManager {
  ...
  nextStepPath(currentStep: string): Observable<string> {
    switch (currentStep) {
      case AdditionalDocumentsWizardStep.ADDITIONAL_DOCUMENTS_UPLOAD:
        return of(`../${AdditionalDocumentsWizardStep.DECISION}`);
      case AdditionalDocumentsWizardStep.DECISION:
