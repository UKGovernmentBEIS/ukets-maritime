...
export class VariationDetailsSummaryFormPayloadMutator extends PayloadMutator {
  private readonly sectionsCompletedMap = inject(SECTIONS_COMPLETE_MAP, { optional: true });
  subtask = VARIATION_DETAILS_SUB_TASK;
  step = VariationDetailsWizardStep.CHANGES_SUMMARY;

  public apply(
    currentPayload: EmpVariationRegulatorTaskPayload,
    userInput: Pick<EmpVariationRegulatorLedReason, 'summary'>,
