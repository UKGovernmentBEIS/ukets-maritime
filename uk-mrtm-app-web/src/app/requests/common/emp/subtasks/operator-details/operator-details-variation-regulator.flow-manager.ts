...
export class OperatorDetailsVariationRegulatorFlowManager extends WizardFlowManager {
  ...
  nextStepPath(currentStep: string): Observable<string> {
    switch (currentStep) {
      ...
      case OperatorDetailsWizardStep.OPERATOR_DETAILS_ORGANISATION_DETAILS:
        return of(`../${OperatorDetailsWizardStep.VARIATION_REGULATOR_DECISION}`);
      case OperatorDetailsWizardStep.VARIATION_REGULATOR_DECISION:
