...
export const EMISSIONS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@requests/common/emp/subtasks/emissions/list-of-ships').then((c) => c.ListOfShipsComponent),
  },
  {
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import('@requests/common/emp/subtasks/emissions/ship-summary').then((c) => c.ShipSummaryComponent),
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('@requests/common/emp/subtasks/emissions/measurements').then((c) => c.MeasurementsComponent),
      },
      {
        ...
        loadComponent: () =>
          import('@requests/common/emp/subtasks/emissions/carbon-capture').then((c) => c.CarbonCaptureComponent),
      },
      {
        ...
        loadComponent: () =>
          import('@requests/common/emp/subtasks/emissions/exemption-conditions').then(
            (c) => c.ExemptionConditionsComponent,
          ),
      },
    ],
  },
