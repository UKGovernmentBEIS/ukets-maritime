...
export class MandateVariationRegulatorFlowManager extends WizardFlowManager {
  ...
  public nextStepPath(currentStep: string): Observable<string> {
    switch (currentStep) {
      ...
      case MandateWizardStep.RESPONSIBILITY_DECLARATION:
        return of(`../${MandateWizardStep.VARIATION_REGULATOR_DECISION}`);
      case MandateWizardStep.VARIATION_REGULATOR_DECISION:
