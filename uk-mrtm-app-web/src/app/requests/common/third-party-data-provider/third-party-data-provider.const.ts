...
export const EXTRA_WARNING = new InjectionToken<Signal<string>>('Extra warnings');
export const EXTRA_DETAILS = new InjectionToken<Signal<string>>('Extra details');
export const SUCCESS_MESSAGES = new InjectionToken<Signal<string[]>>('Success message');
