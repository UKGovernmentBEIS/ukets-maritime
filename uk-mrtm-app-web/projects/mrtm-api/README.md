...
This library wraps the OpenAPI generator's results based on the current [swagger.json](http://localhost:8085/api/v3/api-docs) file.

## Usage

Import any part of the generated code from `mrtm-api`. E.g.

```Typescript
import { SomeService } from 'mrtm-api';
```
