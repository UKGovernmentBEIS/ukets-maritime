...
export class EmpsService {
  ...
  public generateGetEmpAttachmentToken(
    ...
    const localVarPath = `/v1.0/emps/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/attachments`;
  ...
  public generateGetEmpDocumentToken(
    ...
    const localVarPath = `/v1.0/emps/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/document`;
    return this.httpClient.request<FileToken>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
