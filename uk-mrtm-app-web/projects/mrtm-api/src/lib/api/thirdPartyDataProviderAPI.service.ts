...
export class ThirdPartyDataProviderAPIService {
  ...
  /**
   * Creates a new third party data provider
   * @param thirdPartyDataProviderCreateDTO
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public createThirdPartyDataProvider(
  ...
  public createThirdPartyDataProvider(
    ...
    if (thirdPartyDataProviderCreateDTO === null || thirdPartyDataProviderCreateDTO === undefined) {
      throw new Error(
        'Required parameter thirdPartyDataProviderCreateDTO was null or undefined when calling createThirdPartyDataProvider.',
      );
    }
    ...
    return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`, {
      ...
      body: thirdPartyDataProviderCreateDTO,
