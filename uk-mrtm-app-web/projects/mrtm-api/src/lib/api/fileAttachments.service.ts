...
export class FileAttachmentsService {
  ...
  public getFileAttachment(
    ...
    const localVarPath = `/v1.0/file-attachments/${this.configuration.encodeParam({ name: 'token', value: token, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
