...
export class RegulatorUsersRegistrationService {
  ...
  public acceptAuthorityAndActivateRegulatorUserFromInvite(
    ...
    const localVarPath = `/v1.0/regulator-users/registration/accept-authority-and-activate-user-from-invitation`;
  ...
  public acceptRegulatorInvitation(
    ...
    const localVarPath = `/v1.0/regulator-users/registration/accept-invitation`;
