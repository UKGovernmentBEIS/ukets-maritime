...
export class VerifierUsersRegistrationService {
  ...
  public acceptAuthorityAndActivateVerifierUserFromInvite(
    ...
    const localVarPath = `/v1.0/verifier-users/registration/accept-authority-and-activate-verifier-user-from-invitation`;
  ...
  public acceptVerifierInvitation(
    ...
    const localVarPath = `/v1.0/verifier-users/registration/accept-invitation`;
    return this.httpClient.request<InvitedUserInfoDTO>('post', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      body: tokenDTO,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
