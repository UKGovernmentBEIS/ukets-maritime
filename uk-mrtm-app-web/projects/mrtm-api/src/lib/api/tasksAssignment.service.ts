...
export class TasksAssignmentService {
  ...
  public assignTask(
    ...
    const localVarPath = `/v1.0/tasks-assignment/assign`;
    return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      body: requestTaskAssignmentDTO,
  ...
  public getCandidateAssigneesByTaskId(
    ...
    const localVarPath = `/v1.0/tasks-assignment/${this.configuration.encodeParam({ name: 'taskId', value: taskId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int64' })}/candidate-assignees`;
    return this.httpClient.request<Array<AssigneeUserInfoDTO>>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  public getCandidateAssigneesByTaskType(
    ...
    const localVarPath = `/v1.0/tasks-assignment/${this.configuration.encodeParam({ name: 'taskId', value: taskId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int64' })}/candidate-assignees/${this.configuration.encodeParam({ name: 'taskType', value: taskType, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
    return this.httpClient.request<Array<AssigneeUserInfoDTO>>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
