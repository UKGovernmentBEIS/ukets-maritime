...
export class MiReportsUserDefinedService {
  ...
  public generateCustomReport(
    ...
    const localVarPath = `/v1.0/mireports/user-defined/generate-custom`;
    return this.httpClient.request<MiReportUserDefinedResult>('post', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      body: customMiReportQuery,
