...
export class RequestActionFileDocumentsHandlingService {
  ...
  public generateRequestActionGetFileDocumentToken(
    ...
    const localVarPath = `/v1.0/request-action-file-documents/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int64' })}`;
